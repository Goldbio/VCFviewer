...
our $REVISION = '$Revision: 785d370a373105039272854597fe463bf74cfbfb $';
our $DATE =	'$Date: 2014-07-22 10:06:34 -0700 (Tue, 22 Jul 2014) $';  
our $AUTHOR =	'$Author: Kai Wang <kai@openbioinformatics.org> $';

our ($verbose, $help, $man);
our ($queryfile, $dbloc);
our ($outfile, $buildver, $remove, $checkfile, $protocol, $operation, $otherinfo, $onetranscript, $nastring, $genericdbfile, $gff3dbfile, $bedfile, $vcfdbfile, $csvout, $argument, $tempdir, $vcfinput);
our $orig_command = join (" ", $0, @ARGV);
...
GetOptions('verbose|v'=>\$verbose, 'help|h'=>\$help, 'man|m'=>\$man, 'outfile=s'=>\$outfile, 'buildver=s'=>\$buildver, 'remove'=>\$remove, 'checkfile!'=>\$checkfile, 
	...
	'csvout'=>\$csvout, 'argument=s'=>\$argument, 'tempdir=s'=>\$tempdir, 'vcfinput'=>\$vcfinput,
	) or pod2usage ();
...
=head1 SYNOPSIS
 ...
 Version: $Date: 2014-07-22 10:06:34 -0700 (Tue, 22 Jul 2014) $
